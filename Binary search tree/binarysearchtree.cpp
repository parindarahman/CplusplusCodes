...
bool TreeType<ItemType>::IsFull()
{
 ...
 try
 {
 location = new TreeNode<ItemType>;  delete location;
 return false;
 }
...
void Retrieve(TreeNode<ItemType>* tree, ItemType&  item, bool& found)
{
 ...
 Retrieve(tree->left, item, found);  else if (item > tree->info)
 Retrieve(tree->right, item, found);  else
 {
 item = tree->info;
 found = true;
 }
...
void Insert(TreeNode<ItemType>*& tree,  ItemType item)
{
 if (tree == NULL)
 {
 tree = new TreeNode<ItemType>;  tree->right = NULL;
 tree->left = NULL;
 tree->info = item;
 }
 else if (item < tree->info)
...
void DeleteNode(TreeNode<ItemType>*& tree) {
 ...
 {
 GetPredecessor(tree->left, data);  tree->info = data;
